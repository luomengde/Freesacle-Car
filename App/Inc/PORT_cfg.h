...
//      模块通道    端口          可选范围                          建议
#define UART0_RX_PIN    PTB16        //PTA1、PTA15、PTB16、PTD6          PTA1不要用（与Jtag冲突）          //龙邱用的UART0
...
#define UART3_RX_PIN    PTE5       //PTB10、PTC16、PTE5                                                  //山外用的UART3
...
#define FTM0_CH3_PIN    PTA6        //PTC4、PTA6         //山外电机PWM
#define FTM0_CH4_PIN    PTA7        //PTD4、PTA7         //山外电机PWM
...
#define FTM1_CH1_PIN    PTA13        //PTA9、PTA13、PTB1       //山外舵机PWM
...
#define FTM0_CH4_PIN    PTA7        //PTD4、PTA7                     //舵机接口
#define FTM0_CH5_PIN    PTD5        //PTD5、PTA0            PTA0不要用（与Jtag、SWD冲突）
#define FTM0_CH6_PIN    PTD6        //PTD6、PTA1            PTA1不要用（与Jtag冲突）
#define FTM0_CH7_PIN    PTD7        //PTD7、PTA2            PTA2不要用（与Jtag冲突）
...
//正交解码模块通道  端口          可选范围              建议
#define FTM1_QDPHA_PIN  PTA12       //PTA8、PTA12、PTB0      //编码器 黑色A相 
#define FTM1_QDPHB_PIN  PTA13       //PTA9、PTA13、PTB1      //编码器 白色B相
