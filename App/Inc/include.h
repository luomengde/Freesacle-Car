...
//自己添加的头文件
#include  "LCD_BMP.h"           //BMP 液晶显示的图像文件
#include  "VCAN_ASCII.h"        //一些需要用的ASCII表
//#include  "Image_processing.h"  //图像处理
#include  "Direction_control.h" //舵机方向控制
#include  "Speed_control.h"     //速度控制
#include  "Main.h"				//关于main里的一些变量声明
#include  "Init_system.h"       //系统功能初始化
